...
var TimeSlider = function TimeSlider(elementId, options) {
...
TimeSlider.prototype.mousedownFunc = function (e) {
    ...
    this.g_mousedownCursor = this.get_cursor_x_position(e) - 300; //记住mousedown的位置
};
...
TimeSlider.prototype.mousemoveFunc = function (e) {
    var _this = this;
    var pos_x = _this.get_cursor_x_position(e) - 300;
    var px_per_ms = _this.canvansW / (_this.hours_per_ruler * 60 * 60 * 1000); // px/ms
    _this.clearCanvas();
...
TimeSlider.prototype.clearCanvas = function () {
    this.ctx.clearRect(0, 0, 1000, 150);
};
